...
def draw_qr_reportlab(cv, cx, cy, size, url="https://riversrock.fr/setlist/", fill_color=None):
...
def draw_qr_pillow(draw, cx, cy, size, url="https://riversrock.fr/setlist/", fill_color=None):

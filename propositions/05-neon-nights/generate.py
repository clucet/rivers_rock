...
def gen_social():
    ...
    tw = bbox[2] - bbox[0]
    draw.text(((w - tw) / 2, 860), "@riversrock_rouen", fill=(180, 180, 200), font=font_tag)
    ...
    bbox = draw.textbbox((0, 0), "@riversrock_rouen", font=font_tag)
    tw = bbox[2] - bbox[0]
    draw.text(((w - tw) / 2, 1750), "@riversrock_rouen", fill=(180, 180, 200), font=font_tag)
...
<meta name="description" content="Rivers Rock — Neon Nights — Rivers Rock, groupe de reprises rock base a Rouen. Rock, pop-rock, inde et alternatif — 5 musiciens, 12 titres.">
<meta property="og:title" content="Rivers Rock — Neon Nights">
<meta property="og:description" content="Rivers Rock — Neon Nights — Rivers Rock, groupe de reprises rock base a Rouen. Rock, pop-rock, inde et alternatif — 5 musiciens, 12 titres.">
<meta property="og:type" content="music.group">
<meta property="og:url" content="https://clucet.github.io/rivers_rock/propositions/05-neon-nights/">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Rivers Rock — Neon Nights">
<link rel="icon" type="image/svg+xml" sizes="32x32" href="data:image/svg+xml;base64,">

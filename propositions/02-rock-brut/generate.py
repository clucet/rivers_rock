...
def gen_setlist():
    ...
    cv.roundRect(W / 2 - 80, H - 170, 160, 95, 4, stroke=0, fill=1)
    hexagon_logo_reportlab(cv, W / 2, H - 105, 30)
...
def gen_social():
    ...
    tw = bbox[2] - bbox[0]
    draw.text(((w - tw) / 2, 850), "@riversrock_rouen", fill=(150, 150, 150), font=font_tag)
    ...
    bbox = draw.textbbox((0, 0), "@riversrock_rouen", font=font_tag)
    tw = bbox[2] - bbox[0]
    draw.text(((w - tw) / 2, 1750), "@riversrock_rouen", fill=(150, 150, 150), font=font_tag)
...
<meta name="description" content="Rivers Rock — Rock Brut — Rivers Rock, groupe de reprises rock base a Rouen. Rock, pop-rock, inde et alternatif — 5 musiciens, 12 titres.">
...
<section id="musique" class="section">
  ...
  <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:4px;margin-top:16px">
    <div style="position:absolute;top:0;left:0;width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.3);border-radius:4px;font-family:sans-serif;font-size:16px;color:rgba(255,255,255,0.3)"><div style="text-align:center;padding:30px 20px;background:rgba(128,128,128,0.04);border-radius:8px"><p style="color:rgba(128,128,128,0.5);font-size:14px;margin-bottom:12px;font-family:sans-serif">Playlist musicale a venir</p><a href="https://www.youtube.com/@RiversRockRouen" target="_blank" style="display:inline-block;padding:10px 24px;border-radius:6px;background:var(--accent,#E85D3A);color:#fff;text-decoration:none;font-size:13px">Suivre sur YouTube</a></div></div>
  </div>
</section>

...
from palette import CORDES_VOIX as CFG
...
def gen_avatar():
    ...
    draw.text((s//2, s//2), "C", fill=(255,255,255), font=ImageFont.truetype(BEBAS_PATH, 200), anchor="mm")
...
def gen_stickers():
    ...
    for i in range(12):
        ...
        cv.drawCentredString(x + _r, y + _r - 2, "C")
    save_with_crop_marks(cv, W, H, bleed)

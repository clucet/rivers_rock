...
def gen_social():
    ...
    tw = bbox[2] - bbox[0]
    draw.text(((w - tw) / 2, 860), "@riversrock_rouen", fill=(180, 180, 180), font=font_tag)
    ...
    bbox = draw.textbbox((0, 0), "@riversrock_rouen", font=font_tag)
    tw = bbox[2] - bbox[0]
    draw.text(((w - tw) / 2, 1750), "@riversrock_rouen", fill=(180, 180, 180), font=font_tag)
...
<meta name="description" content="Rivers Rock — Ponts &amp; Lumiere — Rivers Rock, groupe de reprises rock base a Rouen. Rock, pop-rock, inde et alternatif — 5 musiciens, 12 titres.">
<meta property="og:title" content="Rivers Rock — Ponts &amp; Lumiere">
<meta property="og:description" content="Rivers Rock — Ponts &amp; Lumiere — Rivers Rock, groupe de reprises rock base a Rouen. Rock, pop-rock, inde et alternatif — 5 musiciens, 12 titres.">
<meta property="og:type" content="music.group">
<meta property="og:url" content="https://clucet.github.io/rivers_rock/propositions/04-ponts-lumiere/">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Rivers Rock — Ponts &amp; Lumiere">
<link rel="icon" type="image/svg+xml" sizes="32x32" href="data:image/svg+xml;base64,">
...
<svg viewBox="-200 -200 400 400">
  ...
  <text x="-75" y="-52.9" text-anchor="middle" class="letter lRI">R</text>
  <text x="-45" y="-71.4" text-anchor="middle" class="letter lI">I</text>
  <text x="-15" y="-79.1" text-anchor="middle" class="letter lV">V</text>
  <text x="15" y="-79.1" text-anchor="middle" class="letter lE">E</text>
  <text x="45" y="-71.4" text-anchor="middle" class="letter lR2">R</text>
...
.footer p{font-family:'DM Mono',monospace;font-size:11px;letter-spacing:4px;color:rgba(255,255,255,0.45)}
...
.scroll-indicator::after{content:'';position:absolute;top:6px;left:50%;transform:translateX(-50%);width:3px;height:8px;background:var(--lumiere);border-radius:2px;animation:scrollDown 2s infinite}
